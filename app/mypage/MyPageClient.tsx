                            ...
                            item.href ? (
                                <a key={item.label} href={item.href}>
                                    <button
                                        ...
                                        style={{ color: activeMenu === item.label ? "#FF9500" : "#3a3a3c", background: "transparent", fontWeight: activeMenu === item.label ? 700 : 500 }}
                                    >
                                        {item.label}
                                    </button>
                                </a>
                        ...
                        {isThemeMenu ? (
                            ...
                            <div className="flex flex-col gap-5 p-7 rounded-[24px]" style={{ background: "rgba(255,255,255,0.7)", backdropFilter: "blur(20px)", border: "1px solid rgba(255,255,255,0.8)", boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        {ORDERS.map((order) => (
                                            <div key={order.name} className="flex items-center justify-between px-4 py-3 rounded-[14px]" style={{ background: "rgba(0,0,0,0.03)" }}>
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="flex items-center justify-between px-4 py-3 rounded-[14px]" style={{ background: "rgba(0,0,0,0.03)" }}>
                                        <span className="text-[13px] font-medium" style={{ color: "#1c1c1e" }}>봄 벚꽃 테마 리뷰를 작성해보세요</span>
                                        <button className="text-[12px] font-semibold px-3 py-1 rounded-full transition-all hover:brightness-105" style={{ background: "rgba(255,231,58,0.95)", color: "#3A1D1D" }}>리뷰 쓰기</button>
                                    </div>
                                </div>
                                <div className="h-[1px]" style={{ background: "rgba(0,0,0,0.07)" }} />
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="flex gap-3">
                                        {RECENT_THEMES.map((theme) => (
                                            <div key={theme.name} className="flex flex-col items-center gap-2 cursor-pointer transition-all hover:-translate-y-0.5">
                                                <div className="w-14 h-14 rounded-[14px]" style={{ background: theme.bg, boxShadow: "0 2px 8px rgba(0,0,0,0.08)" }} />
