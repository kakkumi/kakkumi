...
const steps = [
    ...
    { step: "02", title: "실시간으로 미리봐요", desc: "화면 중앙의 목업에서 내가 만든 테마가 실제 어플에서 어떻게 보이는지 탭별로 확인해요.", accent: "rgb(74,123,247)" },
    { step: "03", title: "다운로드하고 적용해요", desc: "우측 상단 다운로드 버튼을 눌러 .ktheme 파일을 받아 테마 스토어에 등록하거나 바로 적용해요.", accent: "#34c759" },
] as const;
